<%@ Page Title="PaginaPostagemPesquisa" Language="C#" MasterPageFile="~/UserMaterTeste.Master" AutoEventWireup="true" CodeBehind="PaginaInicialPostagemFiltrada.aspx.cs" Inherits="Integrador_Yooyo.PaginaInicialPostagemFiltrada" EnableEventValidation="false" %>
...
<asp:Content runat="server" ID="content2" ContentPlaceHolderID="body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="posti" runat="server">
                            ...
                            <asp:TextBox ID="tituloTXT" MaxLength="50" placeholder="Título" runat="server" Width="464px"></asp:TextBox>
                            ...
                            <asp:TextBox Style="resize: none;" ID="vantagemTXT" MaxLength="500" placeholder="Vantagens" runat="server" TextMode="MultiLine" Height="60px" Width="230px"></asp:TextBox>
                            <asp:TextBox Style="resize: none;" ID="desvantagemTXT" MaxLength="500" placeholder="Desvantagens" runat="server" TextMode="MultiLine" Height="60px" Width="230px"></asp:TextBox>

                            <!--Selecionar imagens-->
                            <h3>Selecionar Categoria</h3>
                            <br />
                            <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource4" DataTextField="descricao" DataValueField="descricao"></asp:ListBox>

                            <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:Ver_Categorias %>' SelectCommand="SELECT [descricao] FROM [Categoria]"></asp:SqlDataSource>
                            <div>
                                ...
                                <br />
                                <asp:Button class="btn btn-success" ID="Postar" OnClick="Postar_Click" runat="server" Text="Postar Publicação" />
    ...
    <asp:Repeater ID="RepPosID" OnItemCommand="Repeater1_ItemCommand" runat="server">
        <ItemTemplate>
