<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TESTE.aspx.cs" Inherits="Integrador_Yooyo.TESTE" %>
                            ...
                            <div class="panel-heading " style="padding: 5px;">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-2 well text-center" style="padding: 1px;">
                                        ...
                                        <button id="ok" class="btn btn-primary" type="button" data-class="btn btn-primary" onclick="filter('ok')"><i class="fa fa-user" aria-hidden="true"></i></button>
                                        <button id="ban" class="btn btn-warning" type="button" data-class="btn btn-warning" onclick="filter('ban')"><i class="fa fa-ban" aria-hidden="true"></i></button>
                                        <button id="new" class="btn btn-success" type="button" data-class="btn btn-success" onclick="filter('new')"><i class="fa fa-check-square" aria-hidden="true"></i></button>
                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="list">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="ban">
                                                    <td class="avatar">
                                                        <img src="https://pbs.twimg.com/profile_images/3511252200/f97a40336742d17609e0b0ca17e301b8_400x400.jpeg"></td>
                                                    <td>Moh Aymen </td>
                                                    <td>Algeria </td>
                                                ...
                                                <tr class="new">
                                                    <td class="avatar">
                                                        <img src="https://pbs.twimg.com/profile_images/3023221270/fcb34337f850c1037af9840ebe510d36_400x400.jpeg"></td>
                                                    <td>Dia ElHak  </td>
                                                    <td>Tunisia </td>
                                                    <td>email@gmail.com </td>
                                                    <td align="center">
